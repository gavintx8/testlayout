...
-(void)viewSetUp{
    ...
    self.promptLabel=[[UILabel alloc]initWithFrame:CGRectMake(self.frame.size.width*0.1,0, self.frame.size.width*0.8, self.frame.size.height)];
    self.promptLabel.backgroundColor=[UIColor whiteColor];
    self.promptLabel.font=[UIFont systemFontOfSize:self.frame.size.height*0.30];
